...
Two weeks ago I had a post about [color meanings]({% post_url 2016-11-01-meaning-of-colors.markdown %}) . Today I want to go through an implementation of color descriptor. Basically, the resulted machinery will take a color (in HSV form) and produces a suitable description. This is a reimplementation of [this work](https://arxiv.org/abs/1606.03821).
